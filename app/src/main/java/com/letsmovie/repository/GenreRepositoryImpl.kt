...
class GenreRepositoryImpl(
    ...
    override fun getTvGenreList(language: String, apiKey: String): Flow<Result<DataGenreResponse>> {
        return flow {
            emit(Result.Loading)
    ...
    override fun getMovieGenreList(language: String, apiKey: String): Flow<Result<DataGenreResponse>> {
        return flow {
            emit(Result.Loading)
